...
/**
  ...
  <p>The framework provides a variety of ways to implement metrics
    ...
    {@link com.pinganfu.owl.metrics.MetricsSource} interface
    ...
    {@link com.pinganfu.owl.metrics.MetricsSink} interface. Producers
  ...
  <dl>
    ...
    <dd>Convenience classes for implementing metrics sources, including the
      Mutable[{@link com.pinganfu.owl.metrics.lib.MutableGauge Gauge}*|
      {@link com.pinganfu.owl.metrics.lib.MutableCounter Counter}*|
      {@link com.pinganfu.owl.metrics.lib.MutableStat Stat}] and
      {@link com.pinganfu.owl.metrics.lib.MetricsRegistry}.
    </dd>
    <dt> <code>org.apache.hadoop.metrics2.filter</code></dt>
    <dd>Builtin metrics filter implementations include the
      {@link com.pinganfu.owl.metrics.filter.GlobFilter} and
      {@link com.pinganfu.owl.metrics.filter.RegexFilter}.
    </dd>
    <dt><code>org.apache.hadoop.metrics2.source</code></dt>
    <dd>Builtin metrics source implementations including the
      {@link com.pinganfu.owl.metrics.source.JvmMetrics}.
    </dd>
    <dt> <code>org.apache.hadoop.metrics2.sink</code></dt>
    <dd>Builtin metrics sink implementations including the
      {@link com.pinganfu.owl.metrics.sink.FileSink}.
    </dd>
    <dt> <code>org.apache.hadoop.metrics2.util</code></dt>
    <dd>General utilities for implementing metrics sinks etc., including the
      {@link com.pinganfu.owl.metrics.util.MetricsCache}.
    </dd>
  </dl>
  ...
  <dl>
    <dt><em>&#064;Metrics</em></dt>
    <dd>The {@link com.pinganfu.owl.metrics.annotation.Metrics} annotation is
    ...
    <dt><em>&#064;Metric</em></dt>
    <dd>The {@link com.pinganfu.owl.metrics.annotation.Metric} annotation
  ...
  <p>Note, the {@link com.pinganfu.owl.metrics.MetricsSource} interface is
